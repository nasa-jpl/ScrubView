                ...
                for (let codeFlow of resultObject.codeFlows) {
                    for (let threadFlow of codeFlow.threadFlows) {
                        for (let location of threadFlow.locations) {
                            ...
                            let threadLocation = fileLocation_1.FileLocation.fromAnalyzerPath(location.location.physicalLocation.artifactLocation.uri, location.location.physicalLocation.region.startLine, buildPath);
