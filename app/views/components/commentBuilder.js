...
class CommentBuilder extends abstractComponent_1.AbstractComponent {
    constructor(state) {
    ...
    buildComment() {
        ...
        let commentText = this.commentTextBox.val();
        // Use markdown?
            ...
            if (this.devDispositionButton.text() == "None") {
                ...
                switch ($("#btn-disposition-developer").text()) {
                    ...
                    case "Discuss":
                        ...
                        break;
                    default:
                        disposition = comments.DeveloperDispositions.None;
                        break;
                }
            ...
            if ($("#btn-disposition-lead").text() == "None") {
                ...
                switch ($("#btn-disposition-lead").text()) {
                    ...
                    case "Code Fix Requested":
                        ...
                        break;
                    default:
                        disposition = comments.LeadDispositions.None;
                        break;
                }
    ...
    _developerDispositionChanged(newDisposition) {
    ...
    _leadDispositionChanged(newDisposition) {
        // Remove Previous Classes
