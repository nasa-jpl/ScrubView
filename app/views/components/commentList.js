...
const commentTile_1 = require("./commentTile");
class CommentList extends abstractComponent_1.AbstractParentComponent {
    constructor(state) {
    ...
    _loadComments() {
        ...
        if (this._state.selectedError.comments.length <= 0) {
            ...
            for (let comment of comments) {
                this.addChildComponent(new commentTile_1.CommentTile(this._state, comment));
            }
        }
    }
}
