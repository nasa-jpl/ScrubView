...
export class ErrorListPaginationManager extends EventEmitter
{
    private readonly _itemsPerPage = 20;
    private _currentPageIndex : number;
    private _itemList : Array<AbstractReviewItem> | null;
    private _displayList : Array<AbstractReviewItem> | null;

    get displayItemList() : Array<AbstractReviewItem> | null { return this._displayList; }
     ...
     */
    public loadDisplayItems(displayItems : Array<AbstractReviewItem>)
    {
        Log.debug(`Paginator received a list of length ${displayItems.length} from the FilterSorter`);
     ...
     */
    private _updatePaginationControls()
    {
        ...
        {
            Log.debug(`Item list is length ${this._itemList.length}. Hiding pagination controls`);
    ...
    public jumpToPage(pageIndex : number)
    {
        ...
        Log.debug("Paginator sending updated error list");
        this.emit("displayListUpdated");
    }

    public getPageForIndex(itemIndex : number)
    {
